...
class Session:
    ...
    def get_project(self) -> Dict[str, Any]:
        if self.project is None:
            raise RuntimeError("没有加载任何文档。请先使用 'document new' 或 'document open'。")
        return self.project
    ...
    def status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "document_type": self.project.get("type", "unknown") if self.project else None,
        }
    ...
    def save_session(self, path: Optional[str] = None) -> str:
        ...
        with open(abs_path, "w", encoding="utf-8") as f:
            json.dump(self.project, f, indent=2, ensure_ascii=False, default=str)
